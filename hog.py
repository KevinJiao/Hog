...
def max_scoring_num_rolls(dice=six_sided):
    ...
    best=0
    while(i>0):
        x=make_averaged(roll_dice,10000)(i,dice)
        if (x>=maxval):
            maxval=x
            best=i
        i-=1
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    "*** YOUR CODE HERE ***"
    #implement hog wild
    #implement free bacon to win
    #calculate margins
    #change num rolls if hog wilded
    #change margin if hog wilded
    def free_bacon(x):
        return abs((x%10)-(x//10))+1
    ...
    if (score>opponent_score+20 and score>50):
        margin=8
        num_rolls=5
